...
It stores passwords in an encrypted format using basic XOR encryption and
file handling.

⚠️ This project is created for learning purposes and is not intended for
production-level security use.
